...
| 10 | `simpleStatus` | 2867431511 | The read side: 12 nutrition reads, all client-side, in one 20 KB file. What a pure client mirror can and cannot see while the server owns the store — and the UI our own mod would overlap | **next** |
