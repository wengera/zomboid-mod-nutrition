...
def test_installed_long_term_preservation_declares_a_different_id():
    ...
    # The exact-count fix, on the real folder the catalog quotes: 17 definitions, and the 30
    # craftRecipe input lines that used to inflate this to 47 are gone.
    assert m["script_item_blocks"] == 17
